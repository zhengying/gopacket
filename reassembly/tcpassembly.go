...
var debugLog = flag.Bool("assembly_debug_log", defaultDebug, "If true, the github.com/zhengying/gopacket/reassembly library will log verbose debugging information (at least one line per packet)")

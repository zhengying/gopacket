...
var memLog = flag.Bool("assembly_memuse_log", defaultDebug, "If true, the github.com/zhengying/gopacket/reassembly library will log information regarding its memory use every once in a while.")

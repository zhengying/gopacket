...
// (github.com/zhengying/gopacket, github.com/zhengying/gopacket/layers).
//
...
var memLog = flag.Bool("assembly_memuse_log", false, "If true, the github.com/zhengying/gopacket/tcpassembly library will log information regarding its memory use every once in a while.")
var debugLog = flag.Bool("assembly_debug_log", false, "If true, the github.com/zhengying/gopacket/tcpassembly library will log verbose debugging information (at least one line per packet)")
